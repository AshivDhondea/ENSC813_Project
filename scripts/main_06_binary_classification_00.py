# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 14:58:23 2020
...
for train, val in kfold.split(x_trainval,y_trainval):
    ...
    # --------------------------------------------------------------------------- #
    history_of_model_1 = model_4.fit_generator(datagen.flow(x_trainval[train], y_trainval[train], batch_size=batch_size_chosen),
    ...
    test_results[:,fold_no-1] = model_4.evaluate(x_test, y_test, batch_size=batch_size_chosen);
