# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 17:38:41 2020

Binary classification

Ensembling the classifiers: Simple CNN (Model 1)
...
model_1.save(full_name+model_name+'model.h5')
model_1.save_weights(full_name+model_name+'weights.h5')
print('Model saved\n')
