# -*- coding: utf-8 -*-
"""
Created on Mon Apr 13 01:00:38 2020
...
history_of_model_1 = model_3.fit_generator(datagen.flow(x_train, y_train, batch_size=batch_size_chosen),
...
model_3.save(full_name+model_name+'model.h5')
model_3.save_weights(full_name+model_name+'weights.h5')
print('Model saved\n')
