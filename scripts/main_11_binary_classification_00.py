# -*- coding: utf-8 -*-
"""
Created on Mon Apr 13 01:30:24 2020
...
datagen = ImageDataGenerator(rescale=1./255,rotation_range=20,width_shift_range=0.1,height_shift_range=0.1,shear_range=0.1,zoom_range=0.1,horizontal_flip=True,fill_mode='reflect') 
...
history_of_model_1 = model_4.fit_generator(datagen.flow(x_train, y_train, batch_size=batch_size_chosen),
...
model_4.save(full_name+model_name+'model.h5')
model_4.save_weights(full_name+model_name+'weights.h5')
print('Model saved\n')
